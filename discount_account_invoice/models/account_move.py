...
class AccountMove(models.Model):
    ...
    def _recompute_tax_lines(self, recompute_tax_base_amount=False):
        ...
        :param lines_map: The line_ids dispatched by type containing:
            ...
            * tax_lines: The lines having a tax_line_id set._recompute_dynamic_linese lines generated by the payment terms of the invoice.
    ...
    def _compute_amount(self):
        for move in self:
            ...
            move.total_discount = total_global_discount 
